...
성별 : <span th:if="${dto.gender == 'M' }">남자</span>
	  <span th:if="${dto.gender == 'F' }">여자</span><br />
등록일 : [[${dto.memberRegist }]]<br />
생년월일 : [[${dto.memberBirth }]]<br />
이메일 : [[${dto.memberEmail }]]<br />
<a href="memberUpdate?memberNum=${dto.memberNum }">회원정보수정</a><br />
<a href="memberDelete?memberNum=${dto.memberNum }">회원탈퇴</a><br />
