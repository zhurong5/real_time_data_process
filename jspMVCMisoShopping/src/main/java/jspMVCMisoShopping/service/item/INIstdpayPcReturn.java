			...
			if("0000".equals(paramMap.get("resultCode"))){
				...
				try{
				  ...
				  //throw new Exception("강제 Exception");
					...
					dto.setCardNum(resultMap.get("CARDNUM"));
					dto.setConfirmNumber(resultMap.get("CONFIRMNUMBER"));
					dto.setPayMethod(resultMap.get("PAYMATHOD"));
					dto.setPurchaseName(resultMap.get("goodsName"));
					dto.setPurchaseNum(resultMap.get("MOID"));
					dto.setResultMessage(resultMap.get("RESULTMASSAGE"));
					dto.setTid(resultMap.get("tid"));
					dto.setTotalPrice(resultMap.get("TOTALPRICE"));
